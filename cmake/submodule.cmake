...
if(${_is_top})
	if(NOT EXISTS "${PROJECT_SOURCE_DIR}/extern/${dirname}/CMakeLists.txt")
		message(SEND_ERROR "Failed to find submodule ${dirname}, file does not exist '${PROJECT_SOURCE_DIR}/extern/${dirname}/CMakeLists.txt'")
	else()
